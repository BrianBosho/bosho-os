...
│   ├── tmlr_fedprop_paper/ ── P1: Closure Priority
│   │   └── tmlr_fedprop_paper.md
│   ├── vlm_grounding_aaai/ ── P2: AAAI Deadline (Jul 21)
│   │   └── vlm_grounding_aaai.md
│   ├── phd_preparation/ ───── P2: PhD Prep & Logistics
│   │   └── phd_preparation.md
│   ├── acubed_colab/ ──────── P3: 10h/wk cap
│   │   └── acubed_colab.md
│   ├── swyng/ ─────────────── P4: 5h/wk cap
│   │   └── swyng.md
│   └── subgraph_topology/ ─── P4: M's collaboration check
│       └── subgraph_topology.md
...
└── Unprocessed/ ──────────── Active drop-zone / inbox
```
